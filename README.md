...
## News
- `2022/06`: AOT-based tracker ranked **1st** in two tracks (segmentation tracking and real-time segmentation tracking) of [VOT2022 Challenge](https://www.votchallenge.net/vot2022/). The technical report will be released by challenge organizors.
- 
